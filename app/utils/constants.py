...
PASSWORD_RESET_LINK_SEND_RATE_LIMIT = 300  # Rate limiting period in seconds
PASSWORD_RESET_LINK_VALIDITY = 300  # in seconds

ACCCOUNT_VERIFICATION_LINK_SEND_RATE_LIMIT = 300  # in seconds
...
EMAIL_CHANGE_TOKEN_RESEND = 300  # in seconds
